...
const SubmitCard = ({ rating }) => {
  return (
    <div className="fadeAnimation bg-cardBG w-[350px] sm:w-[400px] rounded-[2rem] py-[2.4rem] px-[1.5rem]">
      ...
      <article className="mt-6 font-semibold text-description text-center">
